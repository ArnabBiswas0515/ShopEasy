...
const ProductEdit = ({
  ...
  return (
    <div className='fixed w-full h-full top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-slate-200 bg-opacity-50 z-10'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[75%] overflow-hidden'>
            ...
            <form className='grid p-4 gap-2 overflow-y-scroll h-full' onSubmit={handleSubmit}>
                ...
                <button className='px-3 py-2 bg-sky-300 mb-6 rounded hover:bg-sky-400 hover:italic transition-all'>Update Product</button>
            </form>
        </div>
